...
describe("authService", () => {
  ...
  test("loginUser - throws when email not found", async () => {
    ...
    await expect(loginUser({ email: "notfound@example.com", password: "x" })).rejects.toThrow("Invalid email or password");
  ...
  test("loginUser - throws when password is incorrect", async () => {
    ...
    await expect(loginUser({ email: "d@example.com", password: "wrong" })).rejects.toThrow("Invalid email or password");
